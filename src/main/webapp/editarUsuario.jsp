...
<main>
  ...
  <form action="svModificarUsuario" method="post">
    <input type="hidden" name="idUsuario" value="<%= usuario.getId() %>" style="width: 500px">
    <label>Nombre de usuario</label><br>
    <input type="text" name="nombreUsuario" value="<%= usuario.getNombre() %>" style="width: 500px"><br><br>
    <label>Tipo de usuario</label><br>
    <input type="text" name="tipoUsuario" value="<%= usuario.getTipo() %>" style="width: 500px"><br><br>
    <label>Contraseña</label><br>
    <input type="password" name="password" value="<%= usuario.getPass() %>" style="width: 500px"><br><br>
